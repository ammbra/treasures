...
public class Python_h extends Python_h_1 {
    ...
    public static MemorySegment PY_VERSION() {
        class Holder {
            static final MemorySegment PY_VERSION
                = Python_h.LIBRARY_ARENA.allocateFrom("3.11.1");
        }
        return Holder.PY_VERSION;
    }
    private static final int PY_VERSION_HEX = (int)51053040L;
    /**
     * {@snippet lang=c :
     * #define PY_VERSION_HEX 51053040
     * }
     */
    ...
    public static MemorySegment PY_BUILTIN_HASHLIB_HASHES() {
        class Holder {
            static final MemorySegment PY_BUILTIN_HASHLIB_HASHES
                = Python_h.LIBRARY_ARENA.allocateFrom("md5,sha1,sha256,sha512,sha3,blake2");
        }
    ...
    /**
     * {@snippet lang=c :
     * #define __ASSERT_FILE_NAME "jextract$15406656247810961715.h"
     * }
     */
    public static MemorySegment __ASSERT_FILE_NAME() {
        class Holder {
            static final MemorySegment __ASSERT_FILE_NAME
                = Python_h.LIBRARY_ARENA.allocateFrom("jextract$15406656247810961715.h");
        }
