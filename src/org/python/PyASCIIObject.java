...
public class PyASCIIObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_POINTER.withName("wstr")
    ).withName("$anon$72:9");
    ...
    private static final AddressLayout wstr$LAYOUT = (AddressLayout)$LAYOUT.select(groupElement("wstr"));
     ...
     * }
     */
    public static final AddressLayout wstr$layout() {
        return wstr$LAYOUT;
    }

    private static final long wstr$OFFSET = 40;
     ...
     * }
     */
    public static final long wstr$offset() {
        return wstr$OFFSET;
    }
     ...
     * }
     */
    public static MemorySegment wstr(MemorySegment struct) {
        return struct.get(wstr$LAYOUT, wstr$OFFSET);
    }
     ...
     * }
     */
    public static void wstr(MemorySegment struct, MemorySegment fieldValue) {
        struct.set(wstr$LAYOUT, wstr$OFFSET, fieldValue);
    }
