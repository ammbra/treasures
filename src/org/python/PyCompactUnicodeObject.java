...
public class PyCompactUnicodeObject {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        Python_h.C_LONG.withName("wstr_length")
    ).withName("$anon$211:9");
    ...
    private static final long utf8_length$OFFSET = 48;
    ...
    private static final long utf8$OFFSET = 56;
    ...
    private static final OfLong wstr_length$LAYOUT = (OfLong)$LAYOUT.select(groupElement("wstr_length"));
     ...
     * }
     */
    public static final OfLong wstr_length$layout() {
        return wstr_length$LAYOUT;
    }

    private static final long wstr_length$OFFSET = 64;
     ...
     * }
     */
    public static final long wstr_length$offset() {
        return wstr_length$OFFSET;
    }
     ...
     * }
     */
    public static long wstr_length(MemorySegment struct) {
        return struct.get(wstr_length$LAYOUT, wstr_length$OFFSET);
    }
     ...
     * }
     */
    public static void wstr_length(MemorySegment struct, long fieldValue) {
        struct.set(wstr_length$LAYOUT, wstr_length$OFFSET, fieldValue);
    }
