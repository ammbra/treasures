...
public class __sigaction {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        freeglut_h.C_POINTER.withName("sa_tramp"),
        freeglut_h.C_INT.withName("sa_mask"),
        freeglut_h.C_INT.withName("sa_flags")
    ...
    public static class sa_tramp {
        ...
        private static final MethodHandle UP$MH = freeglut_h.upcallHandle(sa_tramp.Function.class, "apply", $DESC);
