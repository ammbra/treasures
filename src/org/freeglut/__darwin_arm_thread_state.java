...
public class __darwin_arm_thread_state {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, freeglut_h.C_INT).withName("__r"),
        freeglut_h.C_INT.withName("__sp"),
        freeglut_h.C_INT.withName("__lr"),
        freeglut_h.C_INT.withName("__pc"),
