...
public class __darwin_ucontext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_INT.withName("uc_onstack"),
        freeglut_h.C_INT.withName("uc_sigmask"),
        __darwin_sigaltstack.layout().withName("uc_stack"),
        freeglut_h.C_POINTER.withName("uc_link"),
        freeglut_h.C_LONG.withName("uc_mcsize"),
        freeglut_h.C_POINTER.withName("uc_mcontext")
