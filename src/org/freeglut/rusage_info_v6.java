...
public class rusage_info_v6 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(16, freeglut_h.C_CHAR).withName("ri_uuid"),
        freeglut_h.C_LONG_LONG.withName("ri_user_time"),
        freeglut_h.C_LONG_LONG.withName("ri_system_time"),
        freeglut_h.C_LONG_LONG.withName("ri_pkg_idle_wkups"),
        freeglut_h.C_LONG_LONG.withName("ri_interrupt_wkups"),
        freeglut_h.C_LONG_LONG.withName("ri_pageins"),
        freeglut_h.C_LONG_LONG.withName("ri_wired_size"),
        freeglut_h.C_LONG_LONG.withName("ri_resident_size"),
        freeglut_h.C_LONG_LONG.withName("ri_phys_footprint"),
        freeglut_h.C_LONG_LONG.withName("ri_proc_start_abstime"),
        freeglut_h.C_LONG_LONG.withName("ri_proc_exit_abstime"),
        freeglut_h.C_LONG_LONG.withName("ri_child_user_time"),
        freeglut_h.C_LONG_LONG.withName("ri_child_system_time"),
        freeglut_h.C_LONG_LONG.withName("ri_child_pkg_idle_wkups"),
        freeglut_h.C_LONG_LONG.withName("ri_child_interrupt_wkups"),
        freeglut_h.C_LONG_LONG.withName("ri_child_pageins"),
        freeglut_h.C_LONG_LONG.withName("ri_child_elapsed_abstime"),
        freeglut_h.C_LONG_LONG.withName("ri_diskio_bytesread"),
        freeglut_h.C_LONG_LONG.withName("ri_diskio_byteswritten"),
        freeglut_h.C_LONG_LONG.withName("ri_cpu_time_qos_default"),
        freeglut_h.C_LONG_LONG.withName("ri_cpu_time_qos_maintenance"),
        freeglut_h.C_LONG_LONG.withName("ri_cpu_time_qos_background"),
        freeglut_h.C_LONG_LONG.withName("ri_cpu_time_qos_utility"),
        freeglut_h.C_LONG_LONG.withName("ri_cpu_time_qos_legacy"),
        freeglut_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_initiated"),
        freeglut_h.C_LONG_LONG.withName("ri_cpu_time_qos_user_interactive"),
        freeglut_h.C_LONG_LONG.withName("ri_billed_system_time"),
        freeglut_h.C_LONG_LONG.withName("ri_serviced_system_time"),
        freeglut_h.C_LONG_LONG.withName("ri_logical_writes"),
        freeglut_h.C_LONG_LONG.withName("ri_lifetime_max_phys_footprint"),
        freeglut_h.C_LONG_LONG.withName("ri_instructions"),
        freeglut_h.C_LONG_LONG.withName("ri_cycles"),
        freeglut_h.C_LONG_LONG.withName("ri_billed_energy"),
        freeglut_h.C_LONG_LONG.withName("ri_serviced_energy"),
        freeglut_h.C_LONG_LONG.withName("ri_interval_max_phys_footprint"),
        freeglut_h.C_LONG_LONG.withName("ri_runnable_time"),
        freeglut_h.C_LONG_LONG.withName("ri_flags"),
        freeglut_h.C_LONG_LONG.withName("ri_user_ptime"),
        freeglut_h.C_LONG_LONG.withName("ri_system_ptime"),
        freeglut_h.C_LONG_LONG.withName("ri_pinstructions"),
        freeglut_h.C_LONG_LONG.withName("ri_pcycles"),
        freeglut_h.C_LONG_LONG.withName("ri_energy_nj"),
        freeglut_h.C_LONG_LONG.withName("ri_penergy_nj"),
        freeglut_h.C_LONG_LONG.withName("ri_secure_time_in_system"),
        freeglut_h.C_LONG_LONG.withName("ri_secure_ptime_in_system"),
        MemoryLayout.sequenceLayout(12, freeglut_h.C_LONG_LONG).withName("ri_reserved")
    ...
    private static final long ri_reserved$OFFSET = 368;
    ...
    private static long[] ri_reserved$DIMS = { 12 };
