...
public class __darwin_arm_thread_state64 {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(29, freeglut_h.C_LONG_LONG).withName("__x"),
        freeglut_h.C_LONG_LONG.withName("__fp"),
        freeglut_h.C_LONG_LONG.withName("__lr"),
        freeglut_h.C_LONG_LONG.withName("__sp"),
        freeglut_h.C_LONG_LONG.withName("__pc"),
        freeglut_h.C_INT.withName("__cpsr"),
        freeglut_h.C_INT.withName("__pad")
