...
public class __darwin_pthread_handler_rec {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_POINTER.withName("__routine"),
        freeglut_h.C_POINTER.withName("__arg"),
        freeglut_h.C_POINTER.withName("__next")
    ...
    public static class __routine {
        ...
        private static final MethodHandle UP$MH = freeglut_h.upcallHandle(__routine.Function.class, "apply", $DESC);
