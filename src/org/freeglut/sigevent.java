...
public class sigevent {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_INT.withName("sigev_notify"),
        freeglut_h.C_INT.withName("sigev_signo"),
        sigval.layout().withName("sigev_value"),
        freeglut_h.C_POINTER.withName("sigev_notify_function"),
        freeglut_h.C_POINTER.withName("sigev_notify_attributes")
    ).withName("sigevent");
    ...
    public static class sigev_notify_function {
        ...
        private static final MethodHandle UP$MH = freeglut_h.upcallHandle(sigev_notify_function.Function.class, "apply", $DESC);
