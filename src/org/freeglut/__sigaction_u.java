...
public class __sigaction_u {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.unionLayout(
        freeglut_h.C_POINTER.withName("__sa_handler"),
        freeglut_h.C_POINTER.withName("__sa_sigaction")
    ...
    public static class __sa_handler {
        ...
        private static final MethodHandle UP$MH = freeglut_h.upcallHandle(__sa_handler.Function.class, "apply", $DESC);
    ...
    public static class __sa_sigaction {
        ...
        private static final MethodHandle UP$MH = freeglut_h.upcallHandle(__sa_sigaction.Function.class, "apply", $DESC);
