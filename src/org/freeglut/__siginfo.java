...
public class __siginfo {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        freeglut_h.C_INT.withName("si_signo"),
        freeglut_h.C_INT.withName("si_errno"),
        freeglut_h.C_INT.withName("si_code"),
        freeglut_h.C_INT.withName("si_pid"),
        freeglut_h.C_INT.withName("si_uid"),
        freeglut_h.C_INT.withName("si_status"),
        freeglut_h.C_POINTER.withName("si_addr"),
        sigval.layout().withName("si_value"),
        freeglut_h.C_LONG.withName("si_band"),
        MemoryLayout.sequenceLayout(7, freeglut_h.C_LONG).withName("__pad")
    ).withName("__siginfo");
